...
/**
 * LinalbarId generated by hbm2java
 */
public class LinalbarId implements java.io.Serializable {
	...
	public LinalbarId(short codemp, short coddel, short codcli, char tipalb, String seralb, short ejerci, int numalb,
			short numlin) {
		this.codemp = codemp;
		this.coddel = coddel;
		this.codcli = codcli;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LinalbarId))
			return false;
		LinalbarId castOther = (LinalbarId) other;
