...
/**
 * Transpor generated by hbm2java
 */
public class Transpor implements java.io.Serializable {

	private TransporId id;
	...
	public Transpor(TransporId id, String cifdni, String nombre, String domici, String poblac) {
		this.id = id;
		this.cifdni = cifdni;
		this.nombre = nombre;
		this.domici = domici;
	...
	public Transpor(TransporId id, String cifdni, String nombre, String domici, Integer codpos, String poblac,
			Short provin, Short pais, String sislog, String telefo, String telefx) {
		this.id = id;
		this.cifdni = cifdni;
		this.nombre = nombre;
		this.domici = domici;
	...
	public TransporId getId() {
		return this.id;
	}

	public void setId(TransporId id) {
		this.id = id;
	}
