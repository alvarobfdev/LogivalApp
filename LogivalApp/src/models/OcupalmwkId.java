...
/**
 * OcupalmwkId generated by hbm2java
 */
public class OcupalmwkId implements java.io.Serializable {
	...
	public OcupalmwkId(String horizo, short vertic, String codart) {
		this.horizo = horizo;
		this.vertic = vertic;
		this.codart = codart;
	}

	public OcupalmwkId(String horizo, short vertic, String codart, Date fcaduc, String lotefb, BigDecimal udsart) {
		this.horizo = horizo;
		this.vertic = vertic;
		this.codart = codart;
		this.fcaduc = fcaduc;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OcupalmwkId))
			return false;
		OcupalmwkId castOther = (OcupalmwkId) other;
