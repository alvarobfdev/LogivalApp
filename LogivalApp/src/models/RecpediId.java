...
/**
 * RecpediId generated by hbm2java
 */
public class RecpediId implements java.io.Serializable {
	...
	public RecpediId(short codemp, short coddel, short codcli, char tipped, String serped, short ejeped, int numped) {
		this.codemp = codemp;
		this.coddel = coddel;
		this.codcli = codcli;
		this.tipped = tipped;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecpediId))
			return false;
		RecpediId castOther = (RecpediId) other;
