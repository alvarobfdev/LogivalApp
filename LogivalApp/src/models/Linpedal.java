...
/**
 * Linpedal generated by hbm2java
 */
public class Linpedal implements java.io.Serializable {

	private LinpedalId id;
	...
	public Linpedal(LinpedalId id) {
		this.id = id;
	}

	public Linpedal(LinpedalId id, Short linped, String codart, String descri, Date fcaduc, String lotefb,
	...
	public LinpedalId getId() {
		return this.id;
	}

	public void setId(LinpedalId id) {
		this.id = id;
	}
