...
/**
 * Linalbar generated by hbm2java
 */
public class Linalbar implements java.io.Serializable {

	private LinalbarId id;
	...
	public Linalbar(LinalbarId id, String codart, BigDecimal cantid, short bultos, BigDecimal kilos, Date fecalb) {
		this.id = id;
		this.codart = codart;
		this.cantid = cantid;
		this.bultos = bultos;
	...
	public Linalbar(LinalbarId id, String codart, BigDecimal cantid, short bultos, BigDecimal kilos, BigDecimal volume,
	...
	public LinalbarId getId() {
		return this.id;
	}

	public void setId(LinalbarId id) {
		this.id = id;
	}
